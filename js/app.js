...
(function (INGAApp) {
    ...
    myApp.addController('EditAssessmentController', INGAApp.EditAssessmentController);
    ...
    myApp.addController('NewAssessmentTemplateController', INGAApp.NewAssessmentTemplateController);
